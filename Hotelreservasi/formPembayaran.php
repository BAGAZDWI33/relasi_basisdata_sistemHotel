...
if (isset($_SESSION["nama"])) {
    ...
    // Redirect atau tindakan lain jika session tidak ada
}
...
<body>
    ...
    <form action="proses/prosesInsertPembayaran.php" method="POST">
        <div class="container">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $sql = "SELECT id_reservasi, nama_tamu, alamat, nama_kamar, fasilitas, 
                tanggal_check_in, tanggal_check_out, lama_inap, total_biaya
                FROM tb_reservasi, tb_fasilitas, tb_kamar
                WHERE tb_kamar.kode_kamar = tb_reservasi.kode_kamar
                AND tb_fasilitas.id_fasilitas = tb_reservasi.id_fasilitas 
                AND tb_reservasi.flag = 1 
                AND tb_reservasi.nama_tamu = '$username'";
                    ...
                    <tr>
                        ...
                        <td><?php echo $data['lama_inap']; ?> hari</td>
        ...
        <div class="container">
            ...
            <a href="proses/prosesInsertPembayaran.php?id=<?php echo $data['id_reservasi'] ?>"
